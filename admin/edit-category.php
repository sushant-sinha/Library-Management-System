...
{   
    ...
    if(isset($_POST['update']))
    {
        ...
        $sql="update genre set Genre=:genre,Status=:status where id=:genreid";
        $query = $dbh->prepare($sql);
        $query->bindParam(':genre',$genre,PDO::PARAM_STR);
        $query->bindParam(':status',$status,PDO::PARAM_STR);
        $query->bindParam(':genreid',$genreid,PDO::PARAM_STR);
        $query->execute();
        $_SESSION['updatemsg']="Genre details updated successfully";
    ...
    <head>
        ...
        <title>Online Library Management System | Manage Genres</title>
      ...
      <div class="content-wrapper">
       <div class="container">
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Edit Genres</h4>
